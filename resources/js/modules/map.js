...
function updateVectorRoadLayerTheme(layerId) {
    ...
    const paint = {
        ...
        'detailed-road-labels': {
            'text-color': isDark ? 'rgba(255, 255, 255, 0.94)' : '#475569',
            'text-halo-color': isDark ? 'rgba(50, 65, 90, 0.94)' : 'rgba(255, 255, 255, 0.92)',
            'text-opacity': isSatellite ? 0.82 : 1,
        },
        'road-name': {
    ...
    for (let boundary = 1; boundary <= 9; boundary += 1) {
        paint[`detailed-road-lane-${boundary}`] = {
    ...
    const layers = [
        {
            ...
            paint: {
                'line-color': '#B6BCC5',
                'line-width': createRoadSurfaceWidthExpression([6, 9, 13, 21, 32]),
                'line-opacity': 0.98,
            },
        },
        {
            id: 'detailed-road-shoulder',
            type: 'line',
            minzoom: 16,
            filter: [
                'all',
            ...
            paint: {
                'line-color': '#C7CDD7',
                'line-width': createRoadSurfaceWidthExpression([4, 6, 9, 15, 24]),
                'line-opacity': 0.98,
            },
        },
        {
            id: 'detailed-road-surface',
            type: 'line',
            minzoom: 16,
            filter: ['==', ['get', 'detailType'], 'road_geometry'],
            layout: {
        ...
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 16, 0.7, 18, 1.1, 20, 2],
        ...
        ...createDetailedRoadLaneLayers(),
        {
            id: 'detailed-road-direction-left',
            type: 'line',
            minzoom: 16,
            filter: [
                'all',
        ...
        {
            id: 'detailed-road-direction-right',
            type: 'line',
            minzoom: 16,
            filter: [
                'all',
        ...
        },
        {
            ...
            filter: [
                'all',
                ['==', ['get', 'detailType'], 'road_geometry'],
                ['any', ['!=', ['get', 'name'], ''], ['!=', ['get', 'ref'], '']],
            ],
            layout: {
                'symbol-placement': 'line',
                'symbol-spacing': ['interpolate', ['linear'], ['zoom'], 16, 420, 18, 280, 20, 210],
                'text-field': [
                    'case',
                    ['!=', ['get', 'name'], ''],
                    ['get', 'name'],
            ...
            paint: {
                ...
                'text-halo-color': 'rgba(50, 65, 90, 0.94)',
                'text-halo-width': 1.4,
            },
        },
        {
            ...
            layout: {
                ...
                'icon-size': ['interpolate', ['exponential', 2], ['zoom'], 16, 0.28, 18, 0.46, 20, 1.52],
...
function createDetailedRoadLaneLayers() {
    return Array.from({ length: 9 }, (_, index) => {
        const boundary = index + 1;

        return {
            id: `detailed-road-lane-${boundary}`,
            type: 'line',
            minzoom: 16,
            filter: [
                'all',
