...
const MAP_STYLE = {
    ...
    layers: [
        ...
        },
        {
            ...
            paint: {
                'line-color': '#D3D0C8',
                'line-width': ['interpolate', ['linear'], ['zoom'], 8, 2, 13, 8, 15, 16, 16, 28, 18, 48],
                'line-opacity': 0.94,
            },
        },
        {
        ...
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 8, 1.2, 13, 6, 15, 13, 16, 25, 18, 44],
                'line-opacity': 0.96,
            },
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 14, 0.5, 16, 1.05, 19, 1.6],
                'line-dasharray': [3, 2],
        ...
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 15, 0.65, 18, 1.2],
                'line-offset': ['interpolate', ['linear'], ['zoom'], 15, -1.6, 17, -3.6, 19, -6.8],
                'line-dasharray': [3, 2],
        ...
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 16, 0.6, 19, 1.1],
                'line-offset': ['interpolate', ['linear'], ['zoom'], 16, -5.2, 18, -8.4, 19, -11.4],
                'line-dasharray': [3, 2],
        ...
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 15, 0.7, 18, 1.25],
                'line-offset': ['interpolate', ['linear'], ['zoom'], 15, -0.85, 18, -1.45],
        ...
        },
        {
            ...
            paint: {
                ...
                'line-width': ['interpolate', ['linear'], ['zoom'], 15, 0.8, 18, 1.35],
                'line-offset': ['interpolate', ['linear'], ['zoom'], 15, -3.8, 16, -5.8, 18, -11.5, 19, -16],
        ...
        },
        {
            ...
            layout: {
                ...
                'symbol-spacing': ['interpolate', ['linear'], ['zoom'], 15, 112, 18, 66],
                'text-field': [
                    'match',
                    ['to-string', ['get', 'oneway']],
                    '-1',
                    '\u2190',
                    '1',
                    '\u2192',
                ...
                'text-size': ['interpolate', ['linear'], ['zoom'], 15, 13, 18, 19],
            ...
            paint: {
                ...
                'text-halo-width': 1.2,
                'text-opacity': ['interpolate', ['linear'], ['zoom'], 15, 0.55, 17, 0.92],
            },
        },
        {
            id: 'place-label',
...
function updateVectorRoadLayerTheme(layerId) {
    ...
    const paint = {
        ...
        'road-direction-arrows': {
            'text-color': isDark ? '#FDE68A' : '#2563EB',
            'text-halo-color': isDark ? 'rgba(24, 35, 52, 0.94)' : 'rgba(255, 255, 255, 0.94)',
            'text-opacity': isSatellite ? 0 : ['interpolate', ['linear'], ['zoom'], 15, 0.55, 17, 0.92],
        },
        'place-label': {
